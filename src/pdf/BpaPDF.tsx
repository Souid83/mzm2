...
interface BpaPDFProps {
  slip: FreightSlip;
}

export const BpaPDF = ({ slip }: BpaPDFProps) => {
    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <View>
          ...
          <Text style={styles.legalText}>
            - Les instructions de ce document doivent être suivies dans le strict respect de le règlementation sociale 
