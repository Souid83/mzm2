...
export default function Disputes() {
  ...
  const disputeTransportSlips = transportSlips.filter(slip => slip.status === 'dispute');
  const disputeFreightSlips = freightSlips.filter(slip => slip.status === 'dispute');
  ...
  return (
    <div className="p-8">
      <h1 className="text-3xl font-bold mb-8">Litiges</h1>
      ...
      {(activeType === 'all' || activeType === 'transport') && disputeTransportSlips.length > 0 && (
        <div className="mb-8">
          ...
          <div className="bg-white rounded-lg shadow-sm overflow-hidden">
            <table className="w-full">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {disputeTransportSlips.map((slip) => (
                  <tr key={slip.id}>
      ...
      {(activeType === 'all' || activeType === 'freight') && disputeFreightSlips.length > 0 && (
        <div>
      ...
      {disputeTransportSlips.length === 0 && disputeFreightSlips.length === 0 && (
